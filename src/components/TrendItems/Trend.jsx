  ...
  return (
    ...
    >
      ...
      <div className="relative w-full lg:w-[80%] mx-0 md:mx-auto text-white pt-0 md:pt-20 px-0 md:px-10 flex flex-col md:flex-row">
        <div className="first-side max-w-48 md:max-w-96 mx-auto">
          <img
        ...
        <div className="second-side flex flex-col gap-1 items-center md:items-start md:gap-3 text-lg md:text-[30px] px-4 lg:pl-24 w-full">
          <div className="text-2xl h-[2.75rem] overflow-hidden md:text-3xl font-semibold !select-all cursor-default pt-4 md:pt-0">
         ...
         {data && data.Genre}
          ...
          <span className="flex flex-row items-center">
            <svg
              ...
              viewBox="0 0 24 24"
              stroke="none"
              className="hidden md:!block size-8 md:size-10 rounded"
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
            ...
            <span className="hidden md:!block">{`${loading && result[dataIndex]?.vote_average.toString().slice(0,3)} /10`}</span>
            
            <img
              src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/69/IMDB_Logo_2016.svg/2560px-IMDB_Logo_2016.svg.png"
              className="hidden md:!block w-12 ml-2"
              alt="IMDB"
            />
          </span>
          <div className="mt-0 md:mt-2 max-h-32 md:max-h-48 md:h-full overflow-hidden hover:overflow-y-auto md:!overflow-hidden text-sm lg:text-lg w-1/2 md:w-full flex-wrap text-wrap custom-scrollbar">
