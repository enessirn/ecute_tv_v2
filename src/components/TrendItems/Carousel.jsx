      ...
      {loading && result?.length > 0 ? (
        result.map((item, index) => (
          <img
            ...
            } rounded-xl shadow-md w-[40%] min-[1300px]:w-[100%] h-24 object-cover  hover:brightness-100 hover:shadow-[0px_0px_40px_10px_rgba(255,0,0,0.45)] transition-all cursor-pointer`}
