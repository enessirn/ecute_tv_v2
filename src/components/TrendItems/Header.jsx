        ...
        {localItems.length !== 0 ? (
          localItems.map((item, i) => {
            return (
              <div
                key={i}
                className="flex flex-row border-b-2 justify-between gap-4 items-center cursor-pointer hover:bg-red-700 w-full rounded-lg px-2 "
              >
                <img
                ...
                />
                <span className="flex items-center justify-center select-none overflow-hidden text-sm mr-7 w-3/4 h-full py-2"  onClick={() => {
                  setHeading(item.title);
                  setClose(false);
                }}>
                  {item && item.title}
                ...
                <span
                  className="absolute right-0 z-50 bg-red-500 h-14 w-9 flex items-center justify-center py-2"
                  onClick={() => {
                    setLocalItems(
                      localItems.filter(
